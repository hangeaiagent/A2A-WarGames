      ...
      <div class="container">
        <div class="hero-content">
          ...
          <div class="hero-cta">
            ...
            <a href="https://github.com/ArtemisAI/A2A-War-Games" target="_blank" class="btn btn-secondary">
      ...
      <div class="container">
        ...
        <div class="llm-compat">
          ...
          <div class="llm-providers">
            ...
            <span class="llm-badge">Ollama</span>
            <span class="llm-badge">Groq</span>
            <span class="llm-badge">Together AI</span>
            <span class="llm-badge">LM Studio</span>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="cta-content">
          ...
          <div class="cta-buttons">
            ...
            <a href="https://github.com/ArtemisAI/A2A-War-Games" target="_blank" class="btn btn-outline btn-lg">
      ...
      <div class="container">
        <div class="footer-content">
          ...
          <div class="footer-links">
            <a href="https://github.com/ArtemisAI/A2A-War-Games" target="_blank">GitHub</a>
            <a href="https://github.com/ArtemisAI/A2A-War-Games/issues" target="_blank">Issues</a>
...
const tryDemo = async () => {
  try {
    await api.post('/api/projects/seed-demo')
  } catch { /* demos may already exist */ }
...
.hero::before {
  ...
  background: radial-gradient(circle at 30% 20%, var(--accent-glow) 0%, transparent 50%),
              radial-gradient(circle at 70% 60%, rgba(124, 92, 191, 0.1) 0%, transparent 50%);
  pointer-events: none;
}
